...
import { conselhoSaudeService, membroConselhoService } from '@/modules/admin/institucional/conselhoSaude.service'
import {
  ConselhoMunicipal,
  MembroConselho,
...
export default function ConselhoSaudeDetalheAdminPage() {
  ...
  const conselhoId = Number(params.id)
  ...
  return (
    <div className="space-y-5">
      <div>
        <Link href="/admin/institucional/conselho-saude" className="text-sm text-admin-accent hover:underline">
          &larr; Voltar para Conselho de Saúde
        </Link>
