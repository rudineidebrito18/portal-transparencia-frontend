...
const licitacoesMock: Licitacao[] = [
  {
    ...
    objeto: "Aquisição de computadores, monitores e periféricos para atender as necessidades da Secretaria Municipal de Administração.",
    covid: false,
    documentos: [],
    contratos: []
  },
  {
    ...
    objeto: "Contratação de empresa especializada para reforma e ampliação da Escola Municipal São José.",
    covid: false,
    documentos: [],
    contratos: []
  }
