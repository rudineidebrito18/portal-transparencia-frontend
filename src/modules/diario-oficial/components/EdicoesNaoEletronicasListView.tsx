...
export default function EdicoesNaoEletronicasListView() {
  const {
    data: edicoes,
    loading,
    erro,
    ...
    setOrdenacao,
    ordenacao
  } = useEdicoesNaoEletronicas()

  return (
    <div className="space-y-6">

      <p className="text-sm text-text-secondary/70">
        Publicações anteriores à existência do Diário Oficial eletrônico — versões físicas digitalizadas.
      </p>

      {/* FILTRO */}
      <EdicaoNaoEletronicaFiltro valoresIniciais={filtros} onFiltrar={setFiltros} />
