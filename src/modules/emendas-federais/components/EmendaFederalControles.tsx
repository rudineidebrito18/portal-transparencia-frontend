...
// Sem exportar — EmendaFederalListView original nunca teve ModalExportar.
export default function EmendaFederalControles({
  totalElements,
  atualizadoEm,
  ordenacaoPadrao = 'atualizadoEm,desc'
}: Props) {
  const { ordenacao, filtros, setOrdenacao, setFiltros } = useEmendaFederalUrlState(ordenacaoPadrao)
