...
// useLicitacaoUrlState (licitacoes/hooks/), pro shape de FiltroEmendaFederal.
export function useEmendaFederalUrlState(ordenacaoPadrao = 'atualizadoEm,desc') {
  ...
  const filtros = {} as FiltroEmendaFederal
  ...
  function setFiltros(novosFiltros: FiltroEmendaFederal) {
