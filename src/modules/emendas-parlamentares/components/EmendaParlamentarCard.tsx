  ...
  return (
    <Card className="p-5 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
        <div>
          <p className="text-xs uppercase text-text-muted">Autoridade</p>
        ...
        <div>
          <p className="text-xs uppercase text-text-muted">Publicação</p>
        ...
        <div>
          <p className="text-xs uppercase text-text-muted">Valor Previsto</p>
        ...
        <div>
          <p className="text-xs uppercase text-text-muted">Valor Repassado</p>
          <p className="font-semibold text-accent">
        ...
        <div>
          <p className="text-xs uppercase text-text-muted">Origem</p>
          <p className="font-semibold text-text-secondary truncate">
            {emenda.origem}
          </p>
        </div>
        ...
        <div>
          <p className="text-xs uppercase text-text-muted">Forma de Repasse</p>
          <p className="font-semibold text-text-secondary truncate">
            {formaRepasseLabel}
          </p>
        </div>
