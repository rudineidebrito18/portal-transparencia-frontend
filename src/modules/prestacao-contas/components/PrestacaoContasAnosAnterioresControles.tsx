...
export const PrestacaoContasAnosAnterioresControles = criarDocumentoGenericoControles({
  listar: params => prestacaoContasService.listar('prestacao-contas-anos-anteriores', params)
})
