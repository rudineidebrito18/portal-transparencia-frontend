...
export const JulgamentoContasLegislativoControles = criarDocumentoGenericoControles({
  listar: params => prestacaoContasService.listar('julgamento-contas-legislativo', params)
})
