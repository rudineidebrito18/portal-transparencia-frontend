...
// useLicitacaoUrlState (licitacoes/hooks/), pro shape de FiltroConcurso.
export function useConcursoUrlState(ordenacaoPadrao = 'dataAbertura,desc') {
  ...
  const filtros = {} as FiltroConcurso
  ...
  function setFiltros(novosFiltros: FiltroConcurso) {
