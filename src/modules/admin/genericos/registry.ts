...
export const REGISTRY_MODULOS_GENERICOS: ModuloGenericoConfig[] = [
  ...
  { slug: 'regulamentacao-esic', label: 'Regulamentação', categoria: 'ESIC e Ouvidoria', basePath: '/esic/regulamentacao', comIntervalo: false, papelMinimoEdicao: 'ROLE_MANAGER' },
  { slug: 'declaracao-solicitacoes-esic', label: 'Declaração de Solicitações', categoria: 'ESIC e Ouvidoria', basePath: '/esic/declaracao-solicitacoes', comIntervalo: false, papelMinimoEdicao: 'ROLE_MANAGER' },
  { slug: 'declaracao-sigilo-esic', label: 'Declaração de Sigilo', categoria: 'ESIC e Ouvidoria', basePath: '/esic/declaracao-sigilo', comIntervalo: false, papelMinimoEdicao: 'ROLE_MANAGER' },
  ...
  { slug: 'relatorios-saude', label: 'Relatório de Saúde', categoria: 'Saúde', basePath: '/saude/relatorios', comIntervalo: false, comExercicio: true, papelMinimoEdicao: 'ROLE_MANAGER' },
  { slug: 'planos-saude', label: 'Plano de Saúde', categoria: 'Saúde', basePath: '/saude/planos', comIntervalo: false, comExercicio: true, papelMinimoEdicao: 'ROLE_MANAGER' },
