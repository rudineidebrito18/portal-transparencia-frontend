...
// useDocumentoGenericoUrlState (shared/hooks/), pro shape de FiltroLicitacao.
// usePageableResource em si não foi tocado (usado por dezenas de páginas fora do escopo desta
// migração, incluindo todo o painel admin).
export function useLicitacaoUrlState(ordenacaoPadrao = 'dataPublicacao,desc') {
  ...
  const filtros = {} as FiltroLicitacao
  ...
  function setFiltros(novosFiltros: FiltroLicitacao) {
