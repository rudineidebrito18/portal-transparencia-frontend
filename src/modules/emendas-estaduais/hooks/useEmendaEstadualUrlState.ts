...
// useLicitacaoUrlState (licitacoes/hooks/), pro shape de FiltroEmendaEstadual.
export function useEmendaEstadualUrlState(ordenacaoPadrao = 'atualizadoEm,desc') {
  ...
  const filtros = {} as FiltroEmendaEstadual
  ...
  function setFiltros(novosFiltros: FiltroEmendaEstadual) {
