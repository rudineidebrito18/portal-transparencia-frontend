...
import { useEmendasEstaduais } from '../hooks/useEmendasEstaduais'
import EmendaEstadualCard from './EmendaEstadualCard'
import EmendaEstadualFiltro from './EmendaEstadualFiltro'

export default function EmendaEstadualListView() {
  const {
    data: emendas,
    loading,
    erro,
        ...
        <>
          ...
          <div className="grid gap-4">
            {emendas.length > 0 ? (
              ...
              <EmptyState message="Nenhuma emenda estadual encontrada com os filtros aplicados." />
            )}
          </div>
