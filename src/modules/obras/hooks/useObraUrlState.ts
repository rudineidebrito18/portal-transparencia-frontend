...
// useLicitacaoUrlState (licitacoes/hooks/), pro shape de FiltroObraPublica.
export function useObraUrlState(ordenacaoPadrao = 'numero,desc') {
  ...
  const filtros = {} as FiltroObraPublica
  ...
  function setFiltros(novosFiltros: FiltroObraPublica) {
