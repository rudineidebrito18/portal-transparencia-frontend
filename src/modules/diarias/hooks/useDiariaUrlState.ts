...
// useLicitacaoUrlState (licitacoes/hooks/), pro shape de FiltroDiaria.
export function useDiariaUrlState(ordenacaoPadrao = 'dataInicio,desc') {
  ...
  function setFiltros(novosFiltros: FiltroDiaria) {
