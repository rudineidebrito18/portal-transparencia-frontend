  ...
  return (
    <Card className="p-5 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-2 text-sm">
        ...
        <div>
          <p className="text-[11px] uppercase text-text-secondary/60">Período</p>
        ...
        <div>
          <p className="text-[11px] uppercase text-text-secondary/60">Qtd. Diárias</p>
          <p className="font-semibold text-text-secondary">{diaria.quantDiarias}</p>
        </div>

        <div className="col-span-2">
          <p className="text-[11px] uppercase text-text-secondary/60">Valor Concedido</p>
