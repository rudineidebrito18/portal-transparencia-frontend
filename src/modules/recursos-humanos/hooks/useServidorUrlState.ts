...
// useLicitacaoUrlState (licitacoes/hooks/), pro shape de FiltroServidor.
export function useServidorUrlState(ordenacaoPadrao = 'name,asc') {
  ...
  const filtros = {} as FiltroServidor
  ...
  function setFiltros(novosFiltros: FiltroServidor) {
