...
export const secoesAcessoInformacao: SecaoAcesso[] = [
  {
    ...
    itens: [
      ...
      { label: 'Atos normativos próprios', icon: MdArticle },
  ...
  },
  {
    ...
    itens: [
      ...
      { label: 'Estagiários', icon: MdWorkOutline },
      { label: 'Terceirizados', icon: MdBusinessCenter },
  ...
  },
  {
    ...
    itens: [
      ...
      { label: 'Fiscal de contrato', icon: MdFactCheck },
  ...
  },
  {
    ...
    icon: MdConstruction,
    itens: [
      { label: 'Obras públicas', icon: MdConstruction },
      { label: 'Obras paralisadas', icon: MdPauseCircleOutline },
    ],
  },
  {
    ...
    itens: [
      ...
      { label: 'Relatórios de gestão e atividades', icon: MdInsertChart },
      ...
      { label: 'Plano estratégico institucional', icon: MdFlag },
  ...
  },
  {
    ...
    itens: [
      { label: 'E-SIC', icon: MdMailOutline },
      ...
      { label: 'Ouvidoria municipal', icon: MdSupportAgent },
  ...
  },
  {
    ...
    itens: [
      { label: 'Planos, relatórios e programação de saúde', icon: MdHealthAndSafety },
      { label: 'Unidades de saúde', icon: MdLocationOn },
      { label: 'Lista de espera para consultas e exames', icon: MdPendingActions },
      { label: 'Medicamentos de alto custo (SUS)', icon: MdLocalPharmacy },
