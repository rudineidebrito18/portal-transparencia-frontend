...
export const secoesAcessoInformacao: SecaoAcesso[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      { label: 'Diárias — legislação e valores', icon: MdMenuBook, href: '/diarias-legislacao' },
  ...
  },
  {
    ...
    icon: MdSecurity,
    itens: [
      { label: 'Proteção de dados (LGPD)', icon: MdPrivacyTip, href: '/lgpd' },
      { label: 'Dados abertos', icon: MdPublic, href: '/lgpd' },
      { label: 'Regulamentação Lei Federal nº 14.129/2021', icon: MdRule, href: '/lgpd' },
      { label: 'Pesquisa de satisfação', icon: MdSentimentSatisfied, href: '/lgpd' },
      { label: 'Serviços públicos', icon: MdMiscellaneousServices, href: '/lgpd' },
    ],
  },
  {
